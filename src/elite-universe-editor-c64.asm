...
CHROUT          = $FFD2
                        ...
                        \ Variables from the Commodore 64 version that aren't in
                        \ the BBC versions

keyLog          = $8D0C \ Key logger table, which is distinct from KL
screenSection   = $A8D9 \ New variable for Commodore 64 version

                        \ Variables in both the BBC versions and the Commodore
                        \ 64 version
